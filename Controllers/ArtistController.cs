...
namespace Itunes_13.Controllers
{
    public class ArtistController : Controller
    {
        ...
        public ArtistController(I_tunes13Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Artists != null ? 
                          ...
                          Problem("Entity set 'I_tunes13Context.Artists'  is null.");
        }
        ...
        public IActionResult TopSellingArtist() {
            Artist artist = _context.Artists.OrderByDescending(a => a.Sales).First();
            return View(artist);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'I_tunes13Context.Artists'  is null.");
            }
            var artist = await _context.Artists.FindAsync(id);
            if (artist != null)
            {
